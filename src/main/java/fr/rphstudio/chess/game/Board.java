...
public class Board {
    ...
    public Board(){
        ...
        Piece PawnBlack = new Piece(IChess.ChessColor.CLR_BLACK, IChess.ChessType.TYP_PAWN,new MovePawn());
        Piece PawnWhite = new Piece(IChess.ChessColor.CLR_WHITE, IChess.ChessType.TYP_PAWN,new MovePawn());
